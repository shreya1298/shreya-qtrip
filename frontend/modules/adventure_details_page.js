...
const getAdventureDetails = new URLSearchParams(search);
const adventureId = getAdventureDetails.get("adventure");
return adventureId;
...
src=${image}
alt =""
class="activity-card-image pb-3 pd-md-0"
/>
    `;
...
//Implementation of conditional rendering DOM based on availability
